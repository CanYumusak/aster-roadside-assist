...
object FakeRoadsideData {
    ...
    val scenarios: List<Scenario> =
        listOf(
            Scenario("scenario-flat-tyre-safe", "Flat tyre, safe roadside", "I have a flat tyre on a quiet residential street. I am parked safely and nobody is injured.", "flat_tire", "I am at Beaconsfield Services, Windsor Road, Beaconsfield HP9 2SE.", "I am safely off the road and there are no passengers at risk.", "covered_repair_truck", listOf("petrol", "diesel", "hybrid")),
            Scenario("scenario-motorway-engine-failure", "Engine failure on motorway shoulder", "The engine cut out on the motorway and I have stopped on the hard shoulder.", "engine_failure", "I am at Reading Services Westbound, M4, Reading RG30 3UQ.", "I am behind the barrier now, but the car is on the hard shoulder.", "covered_tow_and_taxi", listOf("petrol", "diesel", "hybrid")),
            Scenario("scenario-dead-battery", "Dead battery near home", "The car will not start and I think the battery is dead.", "dead_battery", "I am outside Leeds Civic Hall, Calverley Street, Leeds LS1 1UR.", "I am safe and the car is parked.", "covered_repair_truck", listOf("petrol", "diesel", "hybrid")),
            Scenario("scenario-ev-warning", "EV warning light", "My electric car has a red battery warning and reduced power.", "ev_warning", "I am in Cabot Circus car park, Newfoundland Street, Bristol BS2 9AB.", "I am safe, there is no smoke, and the warning light is red.", "human_review_ev_tow", listOf("electric")),
            Scenario("scenario-possible-injury", "Collision with possible injury", "There has been a collision and one passenger may be injured.", "accident_with_injury", "I am near Parker's Piece, Gonville Place, Cambridge CB1 1NA.", "One passenger says their neck hurts.", "safety_escalation_cancelled", listOf("petrol", "diesel", "hybrid", "electric")),
            Scenario("scenario-non-policyholder", "Passenger calling for policyholder", "I am a passenger calling on behalf of the policyholder. They are shaken up and asked me to call.", "third_party_caller", "We are at Peartree Park and Ride, 21 Lakeside, Oxford OX2 8JD.", "We are safe and away from traffic.", "needs_human_callback", listOf("petrol", "diesel", "hybrid", "electric")),
        )
